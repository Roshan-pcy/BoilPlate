...
class NotificationHome2 extends StatefulWidget {
  NotificationHome2({super.key});

  @override
  State<NotificationHome2> createState() => _NotificationHomeState();
}

class _NotificationHomeState extends State<NotificationHome2> {
